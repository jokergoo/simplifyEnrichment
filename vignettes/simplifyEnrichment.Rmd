...
values are adjusted p-values, `default` is set to 1). Let's call this matrix as $M_0$.
...
GO IDs that are not important for the analysis. Functions for `filter` is applied to every row in $M_0$ and `filter` function needs
