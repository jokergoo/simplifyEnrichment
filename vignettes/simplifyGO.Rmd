...
We compare following clustering methods to binary cut: `kmeans`, `dynamicTreeCut`,
...
```{r, echo = FALSE, fig.width = 10, fig.height = 5, fig.cap = "Figure 8. ..."}
...
```{r, echo = FALSE, fig.width = 10, fig.height = 5, fig.cap = "Figure 9. ..."}
...
### Utility functions to compare clustering methods

Here we still use the variable `mat` which is the similarity matrix from the 500 random GO terms.
