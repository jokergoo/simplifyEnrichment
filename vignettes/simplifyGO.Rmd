...
dend = simplifyGO:::cluster_mat(mat)
p1 = grid.grabExpr(simplifyGO:::plot_binary_cut(mat, dend = dend, depth = 1, show_heatmap_legend = FALSE))
p2 = grid.grabExpr(simplifyGO:::plot_binary_cut(mat, dend = dend, depth = 2, show_heatmap_legend = FALSE))
p3 = grid.grabExpr(simplifyGO:::plot_binary_cut(mat, dend = dend, depth = 3, show_heatmap_legend = FALSE))
p4 = grid.grabExpr(simplifyGO:::plot_binary_cut(mat, dend = dend, depth = 4, show_heatmap_legend = FALSE))
library(cowplot)
plot_grid(p1, p2, p3, p4, nrow = 1)
```

```{r, fig.width = 6, fig.height = 4, echo = FALSE, fig.cap = "Figure 4. Splitting the dendrogram."}
simplifyGO:::plot_binary_cut(mat)
```

A nicer way to ...

```{r, fig.width = 5, fig.height = 4, echo = FALSE, fig.cap = "Figure 5. Visualize the ..."}
cl = simplifyGO:::cut_dend(dend)
ht_GO_clusters(mat, cl, draw_word_cloud = FALSE)
```

Once the GO terms are clustered, the ... can be summarized by word cloud.

```{r, fig.width = 8, fig.height = 4, echo = FALSE, fig.cap = "Figure 7. ..."}
